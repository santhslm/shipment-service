 ...
 */
public class OrionMiddlewareDownstreamException extends Exception {
	 ...
	 *            the errorMessage
	 */
	public OrionMiddlewareDownstreamException(ErrorCode errorCode, String errorMessage) {
	 ...
	 *            the errorMessage
	 */
	public OrionMiddlewareDownstreamException(ErrorCode errorCode) {
	 ...
	 *            the errorMessage
	 */
	public OrionMiddlewareDownstreamException(Throwable e, ErrorCode errorCode) {
