...
public class JsonObjectGenerator {
	...
	private static final String JSON_SOURCE_FOLDER = "\\src\\main\\resources\\json\\omwupdatedcreateShipment";
	
	private static final String POJO_DOMAIN_FOLDER = "com.comcast.orion.shipment.omw.updatedRequest";
