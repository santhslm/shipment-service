...
public class LineItem {
    ...
    public LineItem withRequiredWANLicenseCount(Integer requiredWANLicenseCount) {
        this.requiredWANLicenseCount = requiredWANLicenseCount;
        return this;
    }
    ...
    public LineItem withCurrentWANLicenseCount(Integer currentWANLicenseCount) {
        this.currentWANLicenseCount = currentWANLicenseCount;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(deviceMake).append(deviceModel).append(deviceType).append(resourceId).append(quantity).append(requiredWANLicenseCount).append(currentWANLicenseCount).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(deviceMake, rhs.deviceMake).append(deviceModel, rhs.deviceModel).append(deviceType, rhs.deviceType).append(resourceId, rhs.resourceId).append(quantity, rhs.quantity).append(requiredWANLicenseCount, rhs.requiredWANLicenseCount).append(currentWANLicenseCount, rhs.currentWANLicenseCount).isEquals();
    }
